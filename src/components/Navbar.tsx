    ...
    <>
      <nav 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 px-4 sm:px-8 py-6 ${
          isScrolled || isMobileMenuOpen ? "bg-[#120d0c] backdrop-blur-lg py-4 border-b border-brass/10" : "bg-transparent"
        }`}
      >
      ...
      {/* Mobile Menu Overlay - Moved outside nav for better stacking */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <div className="fixed inset-0 z-[100] md:hidden">
            ...
            <motion.div
              ...
              className="absolute top-0 right-0 bottom-0 w-[80%] max-w-[320px] bg-[#120d0c] border-l border-brass/20 p-8 flex flex-col shadow-2xl"
            >
